...
function link_default(links) {
  var id2 = index2, strength = defaultStrength, strengths, distance = constant_default4(30), distances, nodes, count3, bias, random, iterations = 1;
  if (links == null)
    links = [];
...
function area_default4(x0, y0, y1) {
  ...
  x0 = typeof x0 === "function" ? x0 : x0 === void 0 ? x3 : constant_default6(+x0);
  y0 = typeof y0 === "function" ? y0 : y0 === void 0 ? constant_default6(0) : constant_default6(+y0);
  y1 = typeof y1 === "function" ? y1 : y1 === void 0 ? y3 : constant_default6(+y1);
  function area(data) {
...
function pie_default() {
  var value = identity_default3, sortValues = descending_default, sort2 = null, startAngle = constant_default6(0), endAngle = constant_default6(tau5), padAngle = constant_default6(0);
  function pie(data) {
...
function link(curve) {
  ...
  link2.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default6(+_), link2) : y4;
  };
...
function Symbol2(type2, size) {
  ...
  type2 = typeof type2 === "function" ? type2 : constant_default6(type2 || circle_default3);
  ...
  symbol.type = function(_) {
    return arguments.length ? (type2 = typeof _ === "function" ? _ : constant_default6(_), symbol) : type2;
  };
...
function zoom_default2() {
  ...
  function mousedowned(event, ...args) {
    if (touchending || !filter2.apply(this, arguments))
      return;
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v2 = select_default(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default(event, currentTarget), x0 = event.clientX, y0 = event.clientY;
    nodrag_default(event.view);
